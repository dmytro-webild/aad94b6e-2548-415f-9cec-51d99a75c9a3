...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/close-up-smiling-female-face-looking-camera_1262-2974.jpg",
      ...
      bulletPoints={[
        {
          ...
          description: "Dedicated team delivering superior quality and attention to detail in every job.",
        },
        {
          title: "Certified Professionals",
          description: "Our team adheres to industry-leading standards and safety protocols.",
        },
        {
          title: "Customer Satisfaction",
          description: "Your peace of mind and complete satisfaction are our top priorities.",
        },
      ]}
      ...
      features={[
        {
          ...
          imageAlt: "Roofer repairing damaged roof tile",
        },
        {
          id: "replacement",
        ...
        },
        {
          ...
          imageAlt: "Drone view of roof inspection",
        },
        {
          id: "emergency",
          ...
          imageAlt: "Emergency roof tarp after storm damage",
        },
        {
          id: "storm",
          ...
          imageAlt: "Hail damaged roof and insurance claim documents",
        },
        {
          id: "commercial",
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "120+",
          imageSrc: "http://img.b2bpic.net/free-photo/black-wall-paint-textured-background_53876-133009.jpg",
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "60+",
          imageSrc: "http://img.b2bpic.net/free-photo/photo-roof-tiles-texture-pattern_58702-11743.jpg",
          imageAlt: "Spanish clay tile roof",
        },
        {
          id: "flat",
          brand: "CertainTeed",
          name: "EPDM Flat Roofing Systems",
          price: "Custom Quote",
          rating: 4,
          reviewCount: "45+",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-roof-wooden-building_23-2149343649.jpg",
          imageAlt: "Commercial EPDM flat roof",
        },
        {
          id: "cedar",
          brand: "Waldun",
          ...
          imageAlt: "Rustic cedar shake roof",
        },
        {
          id: "slate",
          brand: "Vermont Slate",
          ...
          rating: 5,
          reviewCount: "25+",
          imageSrc: "http://img.b2bpic.net/free-photo/photo-wood-texture-pattern_58702-15389.jpg",
          imageAlt: "Elegant natural slate roof tiles",
        },
      ]}
      ...
      metrics={[
        {
          ...
          description: "Providing exceptional roofing solutions with unmatched expertise.",
          imageSrc: "http://img.b2bpic.net/free-photo/view-ancient-paper-scroll-writing-documenting_23-2151751640.jpg",
          imageAlt: "Clock gears representing years of experience",
        },
        {
          id: "projects",
          value: "1500+",
          title: "Projects Completed",
          description: "Delivering quality and durability on a wide range of roofing installations.",
          imageSrc: "http://img.b2bpic.net/free-photo/sky-residential-formwork-realestate-brick_1232-4003.jpg",
          imageAlt: "Aerial view of a housing development",
        },
        {
          id: "clients",
          value: "98%",
          title: "Client Satisfaction",
          description: "Our commitment to excellence results in happy homeowners and businesses.",
          imageSrc: "http://img.b2bpic.net/free-photo/customer-service-satisfaction-feedback-icon_53876-124008.jpg",
          imageAlt: "People smiling with thumbs up",
        },
        {
          id: "certified",
          value: "A+",
          title: "Certified & Insured",
          description: "Full peace of mind for every client with our accredited services.",
          imageSrc: "http://img.b2bpic.net/free-photo/green-check-mark-gold-circle_84443-94487.jpg",
          imageAlt: "Gold star award for certification",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/smiling-happy-man-shirt-looking-up-copy-space_171337-10785.jpg",
          alt: "John D.",
        },
        {
      ...
      faqs={[
        {
          ...
          content: "We offer comprehensive services including residential and commercial roof repair, full replacements, detailed inspections, and specialized storm damage restoration.",
        },
        {
          id: "q2",
          title: "Are you licensed and insured?",
          content: "Absolutely. Summit Peak Roofing is fully licensed, bonded, and insured, providing complete peace of mind and protection for all our clients and projects.",
        },
        {
          id: "q3",
          title: "How long does a roof replacement take?",
          content: "The duration depends on the roof size, material, and complexity. Most residential roof replacements are completed within 1-3 days, weather permitting, ensuring minimal disruption.",
        },
      ]}
